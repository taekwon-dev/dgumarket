...
public interface ChatRoomService {
    ...
    void changeRoomTransactionStatus (int userId, int roomId, int status); // 채팅방 거래상태 바꾸기
    ...
    ChatRoomTradeHistoryDto checkChatHistory(int userId, int productId); // 물건페이지에서 채팅으로거래하기 클릭했을 때 해당 물건에 대해서 이전에 채팅거래한 적이 있는 지 없는 지 확인하기
}
