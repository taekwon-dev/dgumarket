...
async function uploadImage(e){
    ...
    myHeaders.append("Authorization", "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJiQGRvbmdndWsuZWR1IiwiaWF0IjoxNjE3NjMyNzYzLCJleHAiOjE2MTc2MzM2NjN9.P3Cccs_RvhDKbTK0P14Kvr3J1tsjXVV_OJz8nbywepW4JKcxnKkSut4oOXsFCJ_2zy8IZ5lFrA8BBpRcwZP0yQ");
    myHeaders.append("Cookie", "refreshToken=eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJiQGRvbmdndWsuZWR1IiwiaWF0IjoxNjE3NjMyNzYzLCJleHAiOjE2MTc2NDM1NjN9.EqYBHV7AwFafCvvPsllvcX7fx3s0zUxdl2wE3TaPARVAi7pvdfVMGSB2N3kaAQRRqLTwZVnKa153xuxuHNfUbQ");
...
function sendImages(result){
    if(result != null){
        ...
        response = res;
        // 파싱 후 전송
        // var image_path = "https://dmkimgserver.s3.ap-northeast-2.amazonaws.com/origin/chat/" + file_list[i]
